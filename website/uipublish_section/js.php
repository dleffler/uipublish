<?php
// $Id: js.php,v 1.1 2003/04/15 03:00:34 chavan Exp $
//
 ...
 * for syndication. Here is the suggested Javascript:
   ...
   <!-- Your Website Name -->
   <script type="text/javascript" src="http://www.yourwebsite.com/uipublish_section/js.php">
   </script>
...
$linkpath         = $base_url . $section_dir[$section_id] . "/item.php?id=";
